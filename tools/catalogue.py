"""Publish the control catalogue: every control, with its framework mapping.
    ...
    python -m tools.catalogue --out docs/MERIDIAN_Control_Catalogue.pdf
...
<title>MERIDIAN Control Catalogue</title><style>
...
/* A control identifier must never break across lines. `MERIDIAN-CAT-005` split
   into `MERIDIAN-CAT-` and `005` is unreadable in a printed table and unsearchable
...
<h1>MERIDIAN Control Catalogue</h1>
...
def main(argv=None) -> int:
    ...
    ap.add_argument("--out", default="docs/MERIDIAN_Control_Catalogue.pdf")
