...
def main(argv=None) -> int:
    ...
    from meridian.report import write_html, write_pdf
    from meridian.schema.export import write_baseline
    ...
    for raw in args.configs:
        ...
        dest = out_dir / f"MERIDIAN_Report_{safe}.{args.format}"
