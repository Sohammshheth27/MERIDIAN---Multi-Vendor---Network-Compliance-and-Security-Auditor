...
from meridian.nlp.matcher import Example, NlpMatcher
from meridian.nlp.semantic import SemanticMatcher, _ollama_embed
from meridian.nlp.signals import describe_fields, expand, humanise, infer_type
    ...
    for held in vendors:
        ...
        if not quick:
            ...
            if not sem.dense_available:
                ...
                from meridian.nlp.signals import expand as _x, infer_type as _t
                warm = []
...
def _apply_type(ranked_fields, value):
    ...
    from meridian.nlp.signals import type_multiplier
    vt = infer_type(value)
