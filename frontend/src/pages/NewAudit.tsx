      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
        ...
        >
          ...
          <button
            ...
            className="meridian-btn-primary px-5 py-2.5 rounded-full text-xs font-semibold"
          >
            ...
            {running && (
              <div className="mt-5 p-4 rounded-2xl bg-[var(--color-cloud)] border border-[var(--color-signal-blue)] shadow-sm">
                ...
                <div className="w-full h-1.5 rounded-full bg-[var(--color-hairline)] overflow-hidden mt-3">
                  <div className="h-full w-1/3 bg-[var(--color-signal-blue)] animate-[meridian-indeterminate_1.4s_ease-in-out_infinite]" />
                </div>
