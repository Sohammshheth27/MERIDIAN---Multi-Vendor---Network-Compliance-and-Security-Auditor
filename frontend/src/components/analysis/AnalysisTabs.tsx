    ...
    <div className="space-y-4">
      <Card variant="default" className="p-6">
        ...
        <button
          onClick={ask}
          disabled={busy}
          className="meridian-btn-primary mt-4 rounded-full px-5 py-2.5 text-xs font-semibold disabled:opacity-60"
        >
      ...
      <Card variant="default" className="p-6">
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <button
            ...
            disabled={busy}
            className="meridian-btn-primary rounded-full px-5 py-2.5 text-xs font-semibold disabled:opacity-60"
          >
