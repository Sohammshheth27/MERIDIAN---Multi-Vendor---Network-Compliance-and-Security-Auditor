    ...
    return (
      <button
        ...
        className={cn(
          ...
          variant === 'primary' && "meridian-btn-primary active:scale-[0.98]",
          variant === 'secondary' && "meridian-btn-secondary active:scale-[0.98]",
          ...
          variant === 'action' && "w-full justify-between meridian-panel p-4 hover:border-[var(--color-mist-gray)] hover:bg-[var(--color-pebble)] text-[var(--color-ink-navy)] transition-all",
