...
One rulebook, four labels. We write the check once and attach four
...
A caveat learned from the real STIG files: a control does NOT map 1:1
...
class Control(BaseModel):
    ...
    id: str = Field(description="MERIDIAN-SSH-002")
    title: str
    ...
    # A control that does not apply to a platform is NOT_APPLICABLE,
