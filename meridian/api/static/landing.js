...
(function () {
  ...
  Promise.all([
    ...
    // $KEY / value cells, in the "numbers at a glance" form
    ...
    if (glance) {
      ...
      countUp(glance);
      if (window.__meridianGlanceBars) window.__meridianGlanceBars();
    }
    if (window.__meridianTicker) window.__meridianTicker(plats, fw);
    ...
    if (window.__meridianRing) {
      ...
      if (m) {
        ...
        window.__meridianRing(score, decided / total * 100,
