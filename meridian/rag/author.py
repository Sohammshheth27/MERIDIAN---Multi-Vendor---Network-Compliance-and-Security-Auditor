...
PROPOSED until a person approves it, and approvals are scoped.
...
# Below this fused rank score the candidate is noise. The confidence floor:
# return nothing rather than the best of a bad set.
MIN_RRF = 0.0150
