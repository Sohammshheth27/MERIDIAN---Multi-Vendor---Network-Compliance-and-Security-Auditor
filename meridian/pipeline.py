...
class DeviceAssessment:
    ...
    supported: bool = True
    # The completeness invariant, carried out of the reader:
...
def load_packs(packs_dir="packs") -> list:
    """Every pack on disk; the default directory follows MERIDIAN_PACKS_DIR."""
...
GRAPH_BUILDERS = {
    "sonicwall_sonicos": ("meridian.graph.sonicos_builder", "SonicOS"),
    "juniper_srx": ("meridian.graph.junos_builder", "Junos / SRX"),
    "panos": ("meridian.graph.panos_builder", "PAN-OS"),
    "fortios": ("meridian.graph.fortios_builder", "FortiOS"),
    "security_groups": ("meridian.graph.aws_builder", "AWS security groups"),
    "juniper_srx_xml": ("meridian.graph.junos_xml_builder", "Junos / SRX (XML)"),
    "network_security_groups": ("meridian.graph.azure_builder", "Azure NSG"),
    "gcp_firewall": ("meridian.graph.gcp_builder", "GCP VPC firewall"),
}
