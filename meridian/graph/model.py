...
product; neither is asked for by the MERIDIAN problem statement, which is about
device hardening compliance. Building them would be scope for a different
product. What IS built is the part the security facts depend on: resolve references so
