...
# Confidence by source. The parser is trusted absolutely; an
...
class Observation(BaseModel):
    ...
    def _check_coherence(self) -> "Observation":
        ...
        # An assumed default was by definition never seen, so it
    ...
    def default_assumed(
        ...
        This is NOT the same fact as having observed the value,
    ...
    def is_provable(self) -> bool:
        ...
        assumed default may be right, but it is an inference, and the
        critical rule is that an inference must never masquerade as a finding.
        """
