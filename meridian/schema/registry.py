...
ROADMAP: dict[str, str] = {
    "crypto.ipsec_proposals":       "VPN configuration -- reported in the extended tier, beside the score",
    "routing.bgp_auth":             "router STIG territory -- routing is out of scope for this catalogue",
    "routing.ospf_auth":            "router STIG territory -- routing is out of scope for this catalogue",
    "firewall.nat_rules":           "NAT modelling is deliberately deferred",
    "platform.api.enabled":         "needs the vendor API, not the configuration file",
    ...
    "device.serial":                "serials come from `show version`, not the running configuration",
}
