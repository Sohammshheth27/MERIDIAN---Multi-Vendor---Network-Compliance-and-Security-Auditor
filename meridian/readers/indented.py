...
Library: ciscoconfparse2 (saves roughly a week of hand-written parsing).
...
class IndentedConfig:
    """A parsed indented configuration plus source accounting."""
    ...
    def accounting_snapshot(self) -> dict[str, int]:
        ...
        # PARSED and MAPPED are distinct fates. ciscoconfparse
