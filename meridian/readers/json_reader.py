...
This is the cheapest reader: the data is already structured, so there is no
parsing problem, only a mapping problem.
...
class JsonDocument:
    """A loaded JSON config plus the accounting the invariant needs."""
    ...
    def accounting_snapshot(self) -> dict[str, int]:
        ...
        TOTAL == PARSED + MAPPED + QUARANTINED + UNKNOWN. Only
