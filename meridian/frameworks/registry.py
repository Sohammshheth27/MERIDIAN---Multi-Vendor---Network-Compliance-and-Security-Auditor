...
DEFAULT_ROOT = PROJECT_ROOT / "reference"
...
class FrameworkRegistry(BaseModel):
    ...
    def iso_clauses_for(self, nist_ids: list[str]) -> list[str]:
        """The ISO shortcut: NIST ID -> official crosswalk -> ISO clause.
    ...
    def coverage_report(self) -> str:
        """The honest picture: what is loaded versus what can be automated."""
