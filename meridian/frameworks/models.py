...
class Automatability(str, Enum):
    ...
    Most of a framework cannot be: half of ISO 27001 is about policies and
    people, and a tool claiming to automate it would be lying. Recording this
    per entry is what produces an honest coverage number instead of a
    flattering one.
    """
