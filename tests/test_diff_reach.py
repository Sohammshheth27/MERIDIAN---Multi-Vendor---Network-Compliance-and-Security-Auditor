...
The two capabilities every comparable product has and MERIDIAN did not:
...
from meridian.diff import COVERAGE, IMPROVED, REGRESSED, compare, snapshot
from meridian.diff.compare import Snapshot, _direction, device_identifiers
from meridian.graph.model import ObjectGraph, SecurityRule
from meridian.graph.reach import Query, _addr_in, _svc_matches, ask
...
def test_hit_counts_do_not_make_every_rule_look_changed():
    ...
    from meridian.diff.compare import _rule_signature
