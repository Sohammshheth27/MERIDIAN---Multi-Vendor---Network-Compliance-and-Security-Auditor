...
from meridian.consensus import ParserAgreement, crosscheck_braces
from meridian.consensus.parsers import _found_by, _library_paths, _pack_paths
...
def test_library_failure_is_not_a_finding_about_the_device(monkeypatch):
    ...
    import meridian.consensus.parsers as mod
