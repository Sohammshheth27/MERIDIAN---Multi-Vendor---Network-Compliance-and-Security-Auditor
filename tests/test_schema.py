...
The schema is agreed up front and then treated as fixed, so these
...
class TestObservation:
    ...
    def test_the_distinction_that_matters(self):
        """The reason Observation exists at all.
    ...
    def test_confidence_is_derived_not_supplied(self):
        """An approved AI mapping is permanently 0.9, not 1.0."""
...
class TestEnums:
    def test_seven_result_states_despite_the_heading(self):
        """The original specification said 'six' but listed seven. Seven is correct."""
    ...
    def test_only_pass_fail_partial_score(self):
        """NA/MANUAL/UNKNOWN/ERROR leave the denominator alone."""
    ...
    def test_fail_and_partial_need_evidence(self):
        """Every FAIL and PARTIAL must carry evidence."""
    ...
    def test_severity_weights(self):
        """Severity weighting used by the compliance score."""
...
class TestSBM:
    ...
    def test_scoped_vty_paths_accepted(self):
        """vty is scoped; con and vty must not collide."""
        s = self.sbm()
        s.set(
