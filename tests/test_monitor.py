"""Scheduled re-collection and drift alerts (meridian/collect/monitor.py)."""
import importlib
...
from meridian.collect import live
...
def test_drift_is_alerted_when_the_device_gets_worse(env):
    ...
    assert any("MERIDIAN-SSH-002" in d for d in second["detail"])
