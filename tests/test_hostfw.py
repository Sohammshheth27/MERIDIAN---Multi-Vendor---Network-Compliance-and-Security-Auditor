...
from meridian.graph.hostfw_builder import _norm, _services, build
from meridian.graph.hygiene import analyse
from meridian.graph.reach import Query, ask
from meridian.readers.hostfw import HostFirewall, parse_iptables
...
def test_this_machine_can_be_assessed():
    from meridian.readers.hostfw import collect
    fw = collect()
